...
Toute modification demandée par l'utilisateur qui implique une règle métier, une validation, un comportement UI, ou une contrainte fonctionnelle **DOIT** être documentée dans `docs/MES REGLES METIER.md` avant ou en même temps que le commit.
...
### Format :
- Utiliser les sections existantes de `docs/MES REGLES METIER.md` ou en créer de nouvelles
- Chaque règle doit être claire, concise, et testable

### Règle absolue :
**Ne jamais committer un changement de comportement métier sans avoir mis à jour `docs/MES REGLES METIER.md`.**
